...
cat $SERUMDATA/ERR1797971_trimmed_1U.fastq.gz $SERUMDATA/ERR1797971_trimmed_2U.fastq.gz | bwa mem $GENOME - | samtools view -Sb - > $OUTPUTDIR/unpaired_71.bam

samtools merge $OUTPUTDIR/merged_unsorted_71.bam $OUTPUTDIR/paired_71.bam $OUTPUTDIR/unpaired_71.bam
samtools sort -o $OUTPUTDIR/final_mapped_71.bam $OUTPUTDIR/merged_unsorted_71.bam
